...
/*! lazysizes optimumx plugin - v5.3.2 */
...
/*! lazysizes parent-fit plugin - v5.3.2 */
...
document.addEventListener("lazyloaded",function(e){if(e.target.parentElement.classList.contains("lazyload--placeholder"))e.target.parentElement.classList.remove("lazyload--placeholder");else{const a=e.target.closest(".lazyload-placeholder");a&&a.classList.add("loaded")}});
/*!
  Colorbox 1.6.4
  license: MIT
